package acr.appcradle.shoppinglist.ui.screens.listCreation.nav

import acr.appcradle.shoppinglist.model.ListElement
import acr.appcradle.shoppinglist.ui.screens.listCreation.ListCreationScreen
...
internal fun NavController.navigateToListCreation(list: ListElement? = null) {
...
internal fun NavGraphBuilder.creationScreen(
    onBackClick: () -> Unit,
    onNextClick: () -> Unit,
) {
    composable(
